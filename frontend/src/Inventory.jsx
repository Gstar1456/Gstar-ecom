...
function Inventory() {
  ...
  const getupdatedproduct = async () => {
    setLoading(true)
    let result = await fetch('/api/mic/getupdatedproduct', {
      method: 'GET',
  ...
  const remainingdata = async () => {
    setLoading(true)
    let result = await fetch('/api/mic/remainingdata', {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' }
    });
    result = await result.json();
...
setData(remaindata);
  ...
  const getserialnumber = async () => {
    let result = await fetch('/api/mic/getserialnumber', {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' }
    });
    result = await result.json();
  ...
  const getinvurl = async () => {
    try {
      let result = await fetch('/api/mic/getinvurl', {
        method: "GET",
        headers: { 'Content-Type': 'application/json' }
      })
      result = await result.json();
  ...
  const geterrorurl = async () => {
    try {
      let result = await fetch('/api/mic/geterrorurl', {
        method: "GET",
        headers: { 'Content-Type': 'application/json' }
      })
      result = await result.json();
  ...
  const uploadinventoryfile = async () => {
    ...
    try {
      const response = await axios.post('/api/mic/uploadinvfile', formData, {
        headers: {
  ...
  const setindex = async () => {
    ...
    let result = await fetch('/api/mic/setindex', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const setindex2 = async () => {
    ...
    let result = await fetch('/api/mic/setindex2', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex3 = async () => {
    ...
    let result = await fetch('/api/mic/setindex3', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex4 = async () => {
    ...
    let result = await fetch('/api/mic/setindex4', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex5 = async () => {
    ...
    let result = await fetch('/api/mic/setindex5', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex6 = async () => {
    ...
    let result = await fetch('/api/mic/setindex6', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex7 = async () => {
    ...
    let result = await fetch('/api/mic/setindex7', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex8 = async () => {
    ...
    let result = await fetch('/api/mic/setindex8', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const seterrorindex = async () => {
    ...
    let result = await fetch('/api/mic/seterrorindex', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const autofetchData = async (link) => {
    try {
      let result = await fetch('/api/mic/autofetchdata1', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const autofetchData2 = async (link) => {
    try {
      let result = await fetch('/api/mic/autofetchdata2', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ link: link })
      });
  ...
  const autofetchData3 = async (link) => {
    try {
      let result = await fetch('/api/mic/autofetchdata3', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ link: link })
      });
  ...
  const autofetchData4 = async (link) => {
    try {
      let result = await fetch('/api/mic/autofetchdata4', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ link: link })
      });
  ...
  const autofetchData5 = async (link) => {
    try {
      let result = await fetch('/api/mic/autofetchdata5', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ link: link })
      });
  ...
  const autofetchData6 = async (link) => {
    try {
      let result = await fetch('/api/mic/autofetchdata6', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ link: link })
      });
  ...
  const autofetchData7 = async (link) => {
    try {
      let result = await fetch('/api/mic/autofetchdata7', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ link: link })
      });
  ...
  const autofetchData8 = async (link) => {
    try {
      let result = await fetch('/api/mic/autofetchdata8', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ link: link })
      });
  ...
  const autofetchDataerror = async (link) => {
    try {
      let result = await fetch('/api/mic/autofetchdata', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ link: link })
      });
    ...
    try {
      ...
      if (ans === undefined || true) {
        ...
        const response = await axios({
          url: '/api/mic/download-inventory', // Replace with your backend URL
          method: 'GET',
