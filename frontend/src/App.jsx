...
const showgraph=()=>{
  ...
  const getserialnumber = async () => {
    let result = await fetch('/api/getserialnumber', {
      method: 'GET',
  ...
  const geterrorurl = async () => {
    ...
    try {
      let result = await fetch('/api/geterrorurl', {
        method: "GET",
        headers: { 'Content-Type': 'application/json' }
      })
      result = await result.json();
  ...
  const setindex = async () => {
    ...
    let result = await fetch('/api/setindex', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const setindex2 = async () => {
    ...
    let result = await fetch('/api/setindex2', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex3 = async () => {
    ...
    let result = await fetch('/api/setindex3', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex4 = async () => {
    ...
    let result = await fetch('/api/setindex4', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex5 = async () => {
    ...
    let result = await fetch('/api/setindex5', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex6 = async () => {
    ...
    let result = await fetch('/api/setindex6', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex7 = async () => {
    ...
    let result = await fetch('/api/setindex7', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const setindex8 = async () => {
    ...
    let result = await fetch('/api/setindex8', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
  ...
  const seterrorindex = async () => {
    ...
    let result = await fetch('/api/seterrorindex', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ start_index: newIndex })
    });
